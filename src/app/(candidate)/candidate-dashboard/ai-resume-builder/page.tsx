...
export default function AIResumeBuilder() {
  ...
  const [isLoadingSuggestions, setIsLoadingSuggestions] = useState(false);
  const [suggestionsError, setSuggestionsError] = useState<string | null>(null);
  const [portfolioUrl, setPortfolioUrl] = useState<string>('https://codewithrakib.online');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-slate-50 px-6 py-10">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        {/* Current Resume Section */}
        <Card className="max-w-5xl mx-auto bg-white/95 backdrop-blur-sm border-2 border-emerald-100 shadow-xl shadow-emerald-100/30 rounded-2xl overflow-hidden">
          <CardHeader className="pb-6 px-8 pt-8 bg-gradient-to-r from-emerald-50/50 to-transparent">
          ...
          <CardContent className="px-8 py-6">
            {isLoading ? (
              ...
              <div className="p-8 text-center bg-gradient-to-br from-emerald-50 to-emerald-100/30 rounded-xl border border-emerald-200/50">
                <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-emerald-200/50">
                  <FileText className="w-8 h-8 text-white" />
                </div>
                <h3 className="font-semibold text-slate-900 mb-3 text-lg">No Resume Found</h3>
                <p className="text-slate-600">
                  Please upload your resume to your profile first to get started.
                </p>
              </div>
            ) : (
              <div className="bg-gradient-to-r from-emerald-50 via-white to-emerald-50/30 rounded-2xl border-2 border-emerald-100 shadow-lg shadow-emerald-100/20 overflow-hidden">
                {/* Header Section */}
                <div className="p-6 border-b border-emerald-100/50">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-xl shadow-emerald-200/50">
                          <FileText className="w-8 h-8 text-white" />
                        </div>
                        {isEnhanced && (
                          <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-br from-green-400 to-green-500 rounded-full flex items-center justify-center shadow-lg">
                      ...
                      <div>
                        ...
                        {isEnhanced && (
                          <div className="flex items-center gap-2 mt-2">
                            <div className="px-3 py-1 bg-gradient-to-r from-emerald-100 to-emerald-200 rounded-full">
                              <span className="text-xs font-semibold text-emerald-700">✨ AI Enhanced</span>
                            </div>
                          </div>
                        )}
                      </div>
                ...
                {/* Action Section */}
                <div className="p-6 bg-gradient-to-r from-slate-50/50 to-emerald-50/30">
                  <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
                    <div className="flex-1">
                      <p className="text-sm text-slate-600 mb-2">
                        {isEnhanced ? "Your resume has been enhanced with AI. You can re-enhance it anytime." : "Let our AI analyze and enhance your resume for better job matching."}
                      </p>
                    </div>
                    <Button
                      onClick={handleStartAnalysis}
                      disabled={isProcessing || !userResumeData.resumelink}
                      className={`
                      relative px-8 py-4 rounded-2xl font-semibold text-white transition-all duration-300 transform hover:scale-105 active:scale-95
                      ${isProcessing
                          ? "bg-slate-400 cursor-not-allowed"
                          : "bg-gradient-to-r from-emerald-600 via-emerald-700 to-emerald-600 hover:from-emerald-700 hover:via-emerald-800 hover:to-emerald-700 shadow-xl shadow-emerald-200/50 hover:shadow-emerald-300/60"
                        }
                    `}
                    >
                      <div className="flex items-center gap-3">
                        {isProcessing ? (
                          ...
                          <>
                            ...
                            <span>{isEnhanced ? "Re-enhance Resume" : "Enhance with AI"}</span>
                          </>
                        )}
                      </div>
                    </Button>
            ...
            {isEnhanced && (
              <div className="mt-8 p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl shadow-lg shadow-green-100/30">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-lg">
                    <CheckCircle className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h4 className="font-bold text-green-800 text-lg">Resume Enhanced Successfully!</h4>
                    <p className="text-green-700 text-sm">Your resume has been optimized with AI-powered improvements</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {/* AI Improvement Suggestions */}
            {isEnhanced && enhancementResult?.improvements && (
              <div className="mt-8 bg-gradient-to-br from-purple-50 to-indigo-50 border-2 border-purple-200 rounded-2xl overflow-hidden shadow-lg shadow-purple-100/30">
                <div className="p-6 bg-gradient-to-r from-purple-500/10 to-indigo-500/10">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-purple-800 text-lg">AI-Powered Improvements</h4>
                      <p className="text-purple-700 text-sm">Key enhancements applied to your resume</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {enhancementResult.improvements.slice(0, 4).map((improvement, idx) => (
                      <div key={idx} className="flex items-start gap-3 p-3 bg-white/60 rounded-xl border border-purple-200/50">
                  ...
                  <div className="mt-4 p-4 bg-gradient-to-r from-emerald-100/50 to-blue-100/50 rounded-xl border border-emerald-200/50">
                    <p className="text-sm text-slate-700 font-medium text-center">
                      ✨ These improvements are showcased across all resume templates below
                    </p>
                  </div>
                </div>
              </div>
            ...
            {userResumeData?.resumeContext && userResumeData?.preferred_career_track && (
              <div className="mt-10">
                <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100/30 border-2 border-purple-200 rounded-2xl p-8 shadow-lg shadow-purple-100/30">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-6">
                    ...
                    <Button
                      ...
                      disabled={isLoadingSuggestions}
                      className={`
                      px-8 py-4 rounded-2xl font-semibold text-white transition-all duration-300 transform hover:scale-105 active:scale-95
                      ${isLoadingSuggestions
                          ? "bg-slate-400 cursor-not-allowed"
                          : "bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 hover:from-purple-700 hover:via-pink-700 hover:to-purple-700 shadow-xl shadow-purple-200/50 hover:shadow-purple-300/60"
                        }
                    `}
                    >
                      <div className="flex items-center gap-3">
                  ...
                  {suggestionsError && (
                    <div className="p-4 bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-200 rounded-xl mb-4 shadow-lg">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-gradient-to-br from-red-500 to-pink-500 rounded-full flex items-center justify-center">
                          <AlertCircle className="w-5 h-5 text-white" />
                        </div>
                        <span className="text-sm font-medium text-red-800">{suggestionsError}</span>
                      </div>
                    </div>
                  )}
                      ...
                      {resumeSuggestions.bullet_points && resumeSuggestions.bullet_points.length > 0 && (
                        <Card className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-800">
                          ...
                          <CardContent>
                            <div className="space-y-2.5">
                              {resumeSuggestions.bullet_points.map((bullet, idx) => (
                                <div key={idx} className="flex items-start gap-3 p-3 bg-white/60 dark:bg-gray-800/60 rounded-lg border border-green-100 dark:border-green-800/50">
        ...
        <Card className="max-w-5xl mx-auto bg-white/95 backdrop-blur-sm border-2 border-blue-100 shadow-xl shadow-blue-100/30 rounded-2xl overflow-hidden">
          <CardHeader className="pb-6 px-8 pt-8 bg-gradient-to-r from-blue-50/50 to-transparent">
            <CardTitle className="flex items-center gap-3 text-xl">
        ...
        {!isLoading && userResumeData?.resumelink && (isEnhanced || !isProcessing) && (
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {templates.map((template) => (
                <Card key={template.id} className="overflow-hidden hover:shadow-md transition-shadow duration-200">
                  <CardContent className="p-0">
                    {/* Template Preview */}
                    <div className={`h-48 ${template.preview} relative group border-b`}>
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-all duration-300 flex items-center justify-center">
